...
function pagination($contenu, $Article, $Pos){
    
    for($i = 1; $i < $Article; $i++){
        if($contenu[$Pos + $i]){
        echo "
            <section class=\"article col-2\">

                <h2> ".$contenu[$Pos + $i]["titre"]."</h2>
                <div class=\"texte\">".$contenu[$Pos + $i]["letexte"]."</div>
...
<body>
    ...
    <div class="all4Art"> 
        ...
        <a href="<?php if($Page > 0){
            echo "index.php?Pos=".($Pos-4)."&page=".($Page-1);
        } ?>" class="fleche"><</a>

        <?php pagination($contenu,$Article,$Pos); ?>
